...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // Add the ActionListener to the JPasswordField
        jPassword.addActionListener(enterActionListener);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 248, 220)); // Light Cream color
        ...
        jLabel7.setForeground(new java.awt.Color(240, 240, 240)); // Light White
    ...
    private void jPasswordFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jPasswordFocusGained
        ...
        jPassword.setText("");
        if (jPassword.getText().equals("xxx")) {
            jPassword.setText("");
...
//        jLoginFormActionPerformed(null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (username.equals("KL2107009347@student.kuptm.edu.my") && password.equals("123")) {
            SplashScreenFrame sc = new SplashScreenFrame();
            this.dispose();
            sc.setVisible(true);
        } else if (username.equals("KL2107009349@student.kuptm.edu.my") && password.equals("456")) {
            SplashScreenFrame sc = new SplashScreenFrame();
            this.dispose();
            sc.setVisible(true);
            // Add another user's action here
        } else if (username.equals("jannah") && password.equals("123")) {
            SplashScreenFrame sc = new SplashScreenFrame();
            this.dispose();
            sc.setVisible(true);
            // Add yet another user's action here
        } else {
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        JOptionPane.showMessageDialog(this, "Only use email (@student.kuptm.edu.my)");

    }//GEN-LAST:event_jLabel7MouseClicked

    private void jLabel7MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseEntered
        jLabel7.setForeground(Color.blue); // Dark Blue
