...
//       getMaximumWindowBounds());
 ...
 private java.io.File showFileDialog(final boolean open) {
    ...
    javax.swing.filechooser.FileFilter ff = new javax.swing.filechooser.FileFilter() {
       ...
       public boolean accept(java.io.File f) {
          ...
          return f.isDirectory() || name.endsWith(".png") ||    name.endsWith(".bmp") ||    name.endsWith(".gif");
          }
       @Override
       public String getDescription() {
          if(open)
             return "Image (*.jpg, *.jpeg, *.png, *.gif, *.tiff, *.bmp, *.dib)";
          return "Image (*.png, *.bmp, *.gif)";
          }
       };
 ...
 private void embedMessage() {
    ...
    this.validate();
     ...
     // Show Embed Successfully message
     JOptionPane.showMessageDialog(this, "Encode Successful", "Success", JOptionPane.INFORMATION_MESSAGE);
   }
 ...
 private void embedByte (BufferedImage img, byte b, int start, int storageBit) {
    ...
    private void saveImage() {
     ...
     return;    
      ...
      if(!ext.equals("png") && !ext.equals("bmp") &&   !ext.equals("gif")) {
            ext = "png";
            f = new java.io.File(f.getAbsolutePath()+".png");
            }
      try {
         if(f.exists()) f.delete();
         ImageIO.write(embeddedImage, ext, f); // change is here
         } catch(Exception ex) {}
      }
