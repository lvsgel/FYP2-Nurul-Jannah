...
public class LoginForm extends javax.swing.JFrame {
    ...
    public void jPasswordKeyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            if (jTextUserName.getText().equals("Jannah") && jPassword.getText().equals("123")) {
...
//        jLoginFormActionPerformed(null);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        JOptionPane.showMessageDialog(this, "The Password for user 'Jannah' is '123'");
